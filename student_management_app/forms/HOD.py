...
class AddStudentForm(forms.Form):
    ...
    try:
        ...
        for parent in parents:
            ...
            small_par = (parent.id, parent.admin.first_name+" "+parent.admin.last_name)
            parent_list.append(small_par)
    except:
        pass
    parent_id = forms.ChoiceField(label="Parent", choices=parent_list, widget=forms.Select(attrs={"class":"form-control"}))
...
class AddBursarForm(forms.Form):
    ...
    last_name = forms.CharField(label="Last Name", max_length=50,
                                widget=forms.TextInput(attrs={"class": "form-control"}))
    nationality = forms.CharField(label="Nationality", max_length=20, widget=forms.TextInput(attrs={"class":"form-control"}))
    address = forms.CharField(label="Address", max_length=50, widget=forms.TextInput(attrs={"class": "form-control"}))
    gender_choice = (
        ("Male", "Male"),
        ("Female", "Female")
